    ...
    public sealed class ExtensionSyncPackage : Package
    {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidExtensionSyncCmdSet, (int)PkgCmdIDList.cmdidSyncExtensions);
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            var extManager = (SVsExtensionManager)GetService(typeof(SVsExtensionManager));
        }
